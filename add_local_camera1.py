...
class AddLocalCameraPopup(ctk.CTkToplevel):
    def __init__(self, parent):
        ...
        # Define font explicitly to avoid the "Too early" error
    ...
    def setup_ui(self):
        ...
        # Camera Name Section
        ctk.CTkLabel(self.main_frame, text="Camera Name:", font=self.header_font, text_color="white").pack(pady=(15, 5), anchor="w")
        self.ent_cam = ctk.CTkEntry(self.main_frame, width=250, height=35, fg_color="#aaaaaa", text_color="black", border_width=0, font=self.default_font)
        ...
        self.ent_room = ctk.CTkEntry(self.main_frame, width=250, height=35, fg_color="#aaaaaa", text_color="black", border_width=0, font=self.default_font)
    ...
    def confirm_action(self):
        ...
        if room_name.strip():
            # This calls the method in main_dashboard to add the room live
